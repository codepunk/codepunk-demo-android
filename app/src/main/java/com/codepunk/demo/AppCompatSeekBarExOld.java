...
public class AppCompatSeekBarExOld extends AppCompatSeekBar {
    //region Nested classes
    private static abstract class AppCompatSeekBarExImpl {
        void setProgressInternal(
                Class<?>[] parameterTypes,
                AppCompatSeekBarExOld seekBar,
                Object... objects) {
            try {
    ...
    //region Constants
    private static final String TAG = AppCompatSeekBarExOld.class.getSimpleName();
    ...
    //region Constructors
    public AppCompatSeekBarExOld(Context context) {
        super(context);
    }

    public AppCompatSeekBarExOld(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AppCompatSeekBarExOld(Context context, AttributeSet attrs, int defStyleAttr) {
