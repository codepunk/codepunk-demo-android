...
public class InteractiveImageViewActivity
        ...
        InteractiveImageViewEx.OnDrawListener {
    ...
    private InteractiveImageViewEx mImageView;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interactive_image_view_v4);
        ...
        if (savedInstanceState == null) {
            ...
            if (hasCustomPlacement) {
                final float sx = savedInstanceState.getFloat(KEY_IMAGE_SCALE_X);
                final float sy = savedInstanceState.getFloat(KEY_IMAGE_SCALE_Y);
                final float cx = savedInstanceState.getFloat(KEY_IMAGE_CENTER_X, 0.5f);
                final float cy = savedInstanceState.getFloat(KEY_IMAGE_CENTER_Y, 0.5f);
                mImageView.setImageScale(sx, sy, cx, cy);
            }
        }
        ...
        if (fromUser) {
            ...
            switch (seekBar.getId()) {
                ...
                case R.id.seek_pan_y_value:
                    ...
                    mImageView.setImageScale(scaleX, scaleY, centerX, centerY);
                    break;
    ...
    public void onDraw(InteractiveImageView view, Canvas canvas) {
        ...
        final float minScaleX = view.getImageMinScaleX();
        final float maxScaleX = view.getImageMaxScaleX();
        final float minScaleY = view.getImageMinScaleY();
        final float maxScaleY = view.getImageMaxScaleY();
