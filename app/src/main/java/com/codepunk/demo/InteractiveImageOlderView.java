...
public class InteractiveImageOlderView extends AppCompatImageView {
    ...
    public interface OnDrawListener {
        void onDraw(InteractiveImageOlderView view, Canvas canvas);
    }
                ...
                if (scaledDimension < availableDimension) {
                    ...
                    if (mScaleType == ScaleType.FIT_START || mScaleType == ScaleType.FIT_END) {
                        final boolean reversed = (orientation == Orientation.HORIZONTAL &&
                                ViewCompat.getLayoutDirection(InteractiveImageOlderView.this) ==
    ...
    //region Constants
    private static final String TAG = InteractiveImageOlderView.class.getSimpleName();
    //endregion Constants
    ...
    //region Constructors
    public InteractiveImageOlderView(Context context) {
        super(context);
    }

    public InteractiveImageOlderView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public InteractiveImageOlderView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (mOnDrawListener != null) {
            mOnDrawListener.onDraw(InteractiveImageOlderView.this, canvas);
        }
    }
